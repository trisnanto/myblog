                ...
                <div class="flex h-16 items-center justify-between">
                                ...
                                <div>
                                    ...
                                    <button type="button" @click="isOpen = !isOpen"
                                        ...
                                        <img class="size-8 rounded-full"
                                            src="{{ Auth::user()->avatar ? asset('storage/' . Auth::user()->avatar) : asset('img/avatar.png') }}" alt="{{ Auth::user()->name }}'s avatar">
                                        <div class="text-gray-300 text-sm font-medium mx-2">{{ Auth::user()->name }}</div>
                    ...
                    <div class="-mr-2 flex md:hidden">
                        ...
                        <button type="button" @click="isOpen = !isOpen"
                            ...
                            <svg :class="{ 'block': isOpen, 'hidden': !isOpen}"class="size-6" fill="none" viewBox="0 0 24 24" stroke-width="1.5"
                                stroke="currentColor" aria-hidden="true" data-slot="icon">
